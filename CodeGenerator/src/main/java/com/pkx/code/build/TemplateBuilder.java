...
public class TemplateBuilder {
    ...
    // resultPackage
    public static String PACKAGE_RESULT;
    ...
    static {
        try {
            ...
            // 获取对应的配置信息
            PACKAGE_RESULT = props.getProperty("resultPackage");
    ...
    public static void builder(){
        try {
            ...
            if(databaseType.equals("MySQL")){
                ...
                // 创建Result
                Map<String,Object> resultModelMap = new HashMap<String,Object>();
                ResultBuilder.builder(resultModelMap);
            }
